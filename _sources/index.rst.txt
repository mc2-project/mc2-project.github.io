...
### How does MC\ :sup:`2` use enclaves?
...
The diagrams below show a sample workflow of a user using MC\ :sup:`2` for secure data processing in a cloud. Clients first use our MC2 client software to encrypt and upload their data to untrusted cloud storage.
