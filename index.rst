...
MC2's stack supports a single client interface called [MC2 client](https://github.com/mc2-project/mc2-client), as well as the following compute services:
...
The diagrams below show a sample workflow of a client using MC2 for secure data processing in a cloud. Clients first use our MC2 client software to encrypt and upload their data to untrusted cloud storage.
